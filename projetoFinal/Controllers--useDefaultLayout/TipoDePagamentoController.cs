...
namespace projetoFinal.Controllers__useDefaultLayout
{
    public class TipoDePagamentoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IdTipoDePagamento,NomeDoCobrado,InformacoesAdicionais")] TipoDePagamento tipoDePagamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdTipoDePagamento,NomeDoCobrado,InformacoesAdicionais")] TipoDePagamento tipoDePagamento)
        {
