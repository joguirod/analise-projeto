...
namespace projetoFinal.Controllers__useDefaultLayout
{
    public class PagamentoComChequeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Banco,NomeDoBanco,Id,IdTipoDePagamento,NomeDoCobrado,InformacoesAdicionais")] PagamentoComCheque pagamentoComCheque)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Banco,NomeDoBanco,Id,IdTipoDePagamento,NomeDoCobrado,InformacoesAdicionais")] PagamentoComCheque pagamentoComCheque)
        {
